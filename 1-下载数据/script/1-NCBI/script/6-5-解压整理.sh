# cd /mnt/d/迅雷下载/NCBI/PRJNA1112767/
...
# find $(pwd) -type f -name "md5sum.txt" | parallel --bar -j 8 rm {}
...
# # 默认根目录（可用第一个非选项参数覆盖）
# ROOT="/mnt/d/迅雷下载/NCBI/PRJNA1112767"
# OVERWRITE=0
# BACKUP=0
# ROOT_SET=0
...
# 说明:
#   - 默认 ROOT_DIRECTORY = /mnt/d/迅雷下载/NCBI/PRJNA1112767
#   - 默认行为：遇到已存在的目标文件则跳过
